...
const CURRENCY_FIELDS = [
  { id: "budget", label: "Budget for the month:", initial: "500.00" },
  { id: "save", label: "Savings Goal:", initial: "200.00" },
  { id: "groceries", label: "Groceries Limit:", initial: "250.00" },
  { id: "entertainment", label: "Entertainment Limit:", initial: "50.00" },
  { id: "transportation", label: "Transportation Limit:", initial: "50.00" },
];
